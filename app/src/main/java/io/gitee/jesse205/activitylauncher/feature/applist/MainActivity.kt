...
import io.gitee.jesse205.activitylauncher.feature.activitylist.ActivityListActivity
import io.gitee.jesse205.activitylauncher.feature.settings.SettingsActivity
...
import io.gitee.jesse205.activitylauncher.util.getUserFriendlyMessage
...
import io.gitee.jesse205.activitylauncher.util.isOpenable
import io.gitee.jesse205.activitylauncher.util.isSupportEdgeToEdge
import io.gitee.jesse205.activitylauncher.util.launchUri
import io.gitee.jesse205.activitylauncher.util.openApp
...
class MainActivity : BaseActivity(), AdapterView.OnItemClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchInput?.apply {
            setHint(R.string.hint_search_apps)
        }
